...
public class HealthDurid : MonoBehaviour
{
    [SerializeField] private int healthDurid = 1250; 
    ...
    private void Awake () {
    	...
    	this.currentHealth = this.healthDurid;
    ...
    private void UpdateHealthBar (){
    	float pctHealth = ((float)this.currentHealth / (float)this.healthDurid);
